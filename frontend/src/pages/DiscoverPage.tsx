    ...
    <div className="min-h-screen bg-bg">
      ...
      <main className="max-w-4xl mx-auto px-6 py-8">
        ...
        <input
          ...
          className="w-full bg-panel border border-border rounded-lg px-4 py-2.5 text-sm text-white placeholder:text-muted-2 focus:outline-none focus:border-accent/50 mb-4"
        />
